...
public class AnnotationEditor {
    ...
    private JLayeredPane createLayeredPane() {
        JLabel imgLabel = new JLabel(new javax.swing.ImageIcon(originalImage));
    ...
    private void copyAnnotatedImage(JFrame editor) {
        try {
            ...
            api.logging().logToOutput("[Copy Action] Original image size: "
    ...
    private void saveAnnotatedImage(JFrame editor) {
        try {
            ...
            api.logging().logToOutput("[Save Action] Original image size: "
                    + originalImage.getWidth() + "x" + originalImage.getHeight());
