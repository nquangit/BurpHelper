...
import com.burphelper.*;
import com.burphelper.screenshort.Action;
import com.burphelper.pcopy.ExcelFormatter;
import java.awt.*;
...
public class ScreenShortMenuActionHandler {
    private final MontoyaApi api;
    private final Action action;

    public ScreenShortMenuActionHandler(MontoyaApi api) {
        this.api = api;
